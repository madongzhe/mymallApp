...
class Item extends Component<IAppProps,IAppState> {
  config = {
  ...
  constructor(props) {
    ...
    this.state = {
      loaded: false,
      selected: {},
      itemId: parseInt(this.$router.params.itemId),
      visible:''
    }
  }

  componentDidMount() {
    this.props.dispatchItem({ id: this.state.itemId }).then(() => {
